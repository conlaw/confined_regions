...
def main():
    ...
    parser.add_argument("--action_set_name", default="complex_1D")
    parser.add_argument(
        "--methods", nargs="+", type=str, default=["ip"]
    )
    parser.add_argument(
        "--models", nargs="+", type=str, default=[LR_MODEL_NAME]
    )
    parser.add_argument(
        "--stages",
        nargs="+",
        default=["setup", "train", "baselines", "audit", "stats"],
    )
